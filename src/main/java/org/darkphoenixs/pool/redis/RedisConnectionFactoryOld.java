...
class RedisConnectionFactoryOld implements ConnectionFactory<Jedis> {
     ...
     */
    public RedisConnectionFactoryOld(final String host, final int port, final int connectionTimeout, final int soTimeout, final String password, final int database, final String clientName) {
