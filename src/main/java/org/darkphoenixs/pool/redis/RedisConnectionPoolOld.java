...
/**
 * <p>Title: RedisConnectionPoolOld</p>
 ...
 */
@Deprecated
public class RedisConnectionPoolOld extends PoolBase<Jedis> implements ConnectionPool<Jedis> {
     ...
     * @param host       地址
     */
    public RedisConnectionPoolOld(final PoolConfig poolConfig, final String host) {
     ...
     * @param port 端口
     */
    public RedisConnectionPoolOld(final String host, final int port) {
